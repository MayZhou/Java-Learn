...
you can find a compatible message com.mayzhou.runtimeAnnotations.excelkit.converter based on the source `Object` type, and the chosen
message com.mayzhou.runtimeAnnotations.excelkit.converter sets the content type accordingly. If necessary, you can use the
`exchange` methods to explicitly provide the `Content-Type` request header, and that, in
turn, influences what message com.mayzhou.runtimeAnnotations.excelkit.converter is selected.
...
a compatible message com.mayzhou.runtimeAnnotations.excelkit.converter can be found based on the expected response type, which
...
request and response. By default, this com.mayzhou.runtimeAnnotations.excelkit.converter supports all text media types
...
request and response. By default, this com.mayzhou.runtimeAnnotations.excelkit.converter reads and writes the
...
HTTP request and response. By default, this com.mayzhou.runtimeAnnotations.excelkit.converter supports all media types (`{asterisk}/{asterisk}`)
...
This com.mayzhou.runtimeAnnotations.excelkit.converter requires a `Marshaller` and `Unmarshaller` before it can be used. You can inject these
through constructor or bean properties. By default, this com.mayzhou.runtimeAnnotations.excelkit.converter supports
...
com.mayzhou.runtimeAnnotations.excelkit.converter supports `application/json`.
...
through the `ObjectMapper` property. By default, this
com.mayzhou.runtimeAnnotations.excelkit.converter supports `application/xml`.
...
`SAXSource`, and `StreamSource` are supported. By default, this com.mayzhou.runtimeAnnotations.excelkit.converter supports
`text/xml` and `application/xml`.

| `BufferedImageHttpMessageConverter`
| An `HttpMessageConverter` implementation that can read and write
`java.awt.image.BufferedImage` from the HTTP request and response. This com.mayzhou.runtimeAnnotations.excelkit.converter reads
...
The `org.springframework.jms.support.com.mayzhou.runtimeAnnotations.excelkit.converter` package provides a `MessageConverter`
...
and `MapMessage`. By using the com.mayzhou.runtimeAnnotations.excelkit.converter, you and your application code can focus on the
...
generically encapsulated inside a com.mayzhou.runtimeAnnotations.excelkit.converter class, the `MessagePostProcessor` interface
...
| `message-com.mayzhou.runtimeAnnotations.excelkit.converter`
