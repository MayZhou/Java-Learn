...
{api-spring-framework}/http/com.mayzhou.runtimeAnnotations.excelkit.converter/json/Jackson2ObjectMapperBuilder.html[`Jackson2ObjectMapperBuilder`]
...
----
	<mvc:annotation-driven>
		<mvc:message-converters>
			...
			<bean class="org.springframework.http.com.mayzhou.runtimeAnnotations.excelkit.converter.xml.MappingJackson2XmlHttpMessageConverter">
				<property name="objectMapper" ref="xmlMapper"/>
			</bean>
		</mvc:message-converters>
	</mvc:annotation-driven>

	<bean id="objectMapper" class="org.springframework.http.com.mayzhou.runtimeAnnotations.excelkit.converter.json.Jackson2ObjectMapperFactoryBean"
		  p:indentOutput="true"
