...
/**
 * A com.mayzhou.runtimeAnnotations.excelkit.converter to turn the payload of a {@link Message} from serialized form to a typed
...
public interface MessageConverter {
	 ...
	 * <p>If the com.mayzhou.runtimeAnnotations.excelkit.converter does not support the specified media type or cannot perform
