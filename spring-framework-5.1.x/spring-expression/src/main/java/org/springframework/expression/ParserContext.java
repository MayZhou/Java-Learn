...
public interface ParserContext {
	...
	/**
	 * Whether or not the expression being parsed is a prototype. A prototype expression
	 ...
	 *     #{3 + 4}
	 * </pre>
	 * @return true if the expression is a prototype, false otherwise
	 */
	boolean isTemplate();

	/**
	 * For prototype expressions, returns the prefix that identifies the start of an
	...
	/**
	 * For prototype expressions, return the prefix that identifies the end of an
	 * expression block within a string. For example: "}"
	...
	/**
	 * The default ParserContext implementation that enables prototype expression
