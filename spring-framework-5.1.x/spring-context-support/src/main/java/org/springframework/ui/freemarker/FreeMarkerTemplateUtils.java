 ...
 * Provides convenience methods to process a FreeMarker prototype with a model.
 *
...
public abstract class FreeMarkerTemplateUtils {
	...
	/**
	 * Process the specified FreeMarker prototype with the given model and write
	 ...
	 * @throws IOException if the prototype wasn't found or couldn't be read
