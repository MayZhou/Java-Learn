 ...
 * <pre class="code">
 * RestTemplate prototype = new RestTemplate();
 ...
 * prototype.postForLocation("https://example.com/myForm", form);
 * </pre>
 *
 ...
 * prototype.postForLocation("https://example.com/myFileUpload", parts);
 * </pre>
 *
